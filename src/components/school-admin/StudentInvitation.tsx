...
export const StudentInvitation = ({ onSuccess }: StudentInvitationProps) => {
  // Start with an existing code for immediate display
  const [generatedCode, setGeneratedCode] = useState<string>("STUD67FG9H");

  const generateInviteCode = () => {
    // Generate a new code for immediate feedback
