...
const SchoolAdmin = () => {
  // We'll add a check to verify the auth context is available
  try {
    ...
    // Handle the case where useAuth fails
    console.error("Error in SchoolAdmin:", error);
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-grow bg-learnable-super-light py-8">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl">There was an issue loading your admin panel</p>
